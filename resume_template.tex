...
\usepackage[
    pdftitle={Deep Singh's CV},
    pdfauthor={Deep Singh},
...
\begin{document}
    ...
    \begin{header}
        \fontsize{25 pt}{25 pt}\selectfont Deep Singh
        ...
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{mailto:deep.singh@gmail.com}{deep.singh@gmail.com}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{tel:+1-111-111-1111}{111-111-1111}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{https://www.linkedin.com/in/deepsingh}{linkedin.com/in/deepsingh}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{https://github.com/deepsingh}{github.com/deepsingh}}%
    \end{header}
